import{u as p,g as b,j as e,r as u,c,s as I,F as J,A as Q,Z as ee,_ as ae,$ as ne,a0 as se,a1 as ie,a2 as oe,a3 as te,a4 as re,a5 as ce,a6 as me,a7 as le,a8 as ue,a9 as de,a as he,aa as G,ab as $,ac as ge,ad as pe,ae as fe,af as xe,ag as je,ah as ve,ai as ke,aj as be,ak as ye,al as we,am as Se,an as Ce,ao as Me,ap as Ae,aq as Le,i as Ge,ar as ze}from"./index-Fa3IilTd.js";import{M as Te,e as Ie}from"./styledComponents-xCekcd22.js";import{T as Ee}from"./Title-XEyrHU2K.js";import{M as Fe,P as De}from"./Pagination-ZwjfuBFB.js";import"./useIntersectionObserver-zGH8jvZv.js";import"./Rating-9RsVud8F.js";const M=p.div`
  display: flex;
  flex-wrap: wrap;
  gap: 5px;
  color: #fffac8;
...
`,Ve=p.h2`
  ...
  font-size: 20px;
  font-weight: 600;
`;function He({page:a,setPage:s}){const r=c(ee),n=c(ae),i=c(ne),o=c(se),[d,m]=u.useState([]),h=c(ie),[j,x]=u.useState([]),k=c(oe),t=c(te),l=c(re),f=c(ce),w=c(me),S=c(le),C=c(ue),A=c(I),E=c(de),[F,D]=u.useState(!1),v=b(),_=u.useCallback(async(g,U,q,W)=>{try{const X={headers:{Authorization:`bearer ${U}`}},Y=await he.get(`/api/actors/search?search=${g}`,X);W(Y.data.results.filter(L=>L.known_for_department===q).sort((L,Z)=>Z.known_for.length-L.known_for.length).slice(0,10))}catch{m([])}},[]);return u.useEffect(()=>{F&&(v(G()),v($({token:A.token,searchData:{language:i,releaseGte:S.slice(0,4),releaseLte:C.slice(0,4),sortBy:o,voteAverageGte:t,voteAverageLte:l,voteCountGte:f,voteCountLte:w,cast:h.map(g=>g.id).join("|"),crew:k.map(g=>g.id).join("|"),genre:r.join("|"),noGenre:n.join("|")},page:a})))},[a,A,v,i,S,C,o,t,l,f,w,h,k,r,n,F]),u.useEffect(()=>{a>1?D(!0):D(!1)},[a,E,s,v]),u.useEffect(()=>{s(1),v(G())},[v,E,s]),e.jsxs(Re,{children:[e.jsx(Ve,{children:"Filters"}),e.jsx(O,{options:N,selectedOptions:r,setSelectedOptions:ge,title:"Include genres:"}),e.jsx(O,{options:N,selectedOptions:n,setSelectedOptions:pe,title:"Exclude genres:"}),e.jsx(R,{selectedOptions:h,setSelectedOptions:fe,searched:d,setSearched:m,fetch:_,role:"Acting",title:"Include cast"}),e.jsx(R,{selectedOptions:k,setSelectedOptions:xe,searched:j,setSearched:x,fetch:_,role:"Directing",title:"Include director"}),e.jsx(Oe,{ratings:[...new Array(10).keys()].map(g=>g+1+""),setMin:je,setMax:ve,titles:["Min rating","Max rating"]}),e.jsx(V,{min:f,setMin:ke,max:w,setMax:be,titles:["Min vote count","Max vote count"],type:"number",width:"10ch"}),e.jsx(V,{min:S,setMin:ye,max:C,setMax:we,titles:["Released from","to"],type:"date",width:"16ch"}),e.jsx(Ne,{options:Ke,setSelectedOption:Se,title:"Language:"}),e.jsx(T,{options:Be,setSelectedOption:Ce,selectedOption:o,title:"Sort by:"}),e.jsx("div",{children:e.jsx($e,{onClick:()=>{v(G()),s(1),v($({token:A.token,searchData:{language:i,releaseGte:S.slice(0,4),releaseLte:C.slice(0,4),sortBy:o,voteAverageGte:t,voteAverageLte:l,voteCountGte:f,voteCountLte:w,cast:h.map(g=>g.id).join("|"),crew:k.map(g=>g.id).join("|"),genre:r.join("|"),noGenre:n.join("|")},page:a}))},children:"discover"})})]})}function Ze(){const a=c(I),s=c(Me),r=c(Ae),[n,i]=u.useState(r),o=c(Le),[d,m]=u.useState(!1),h=Ge(),j=b();return u.useEffect(()=>{document.getElementById("movie-container").scrollIntoView({behavior:"smooth"}),j(ze(n))},[j,n]),u.useEffect(()=>{const x=setTimeout(()=>m(!0),1e3);return()=>clearTimeout(x)},[]),u.useEffect(()=>{a||h(-1)},[a,h]),e.jsxs(Te,{$loaded:d,children:[e.jsx(Ee,{text:"discover"}),e.jsx(He,{page:n,setPage:i}),s&&e.jsx(Ie,{id:"movie-container",$loaded:!o,children:s.map(x=>e.jsx(Fe,{movie:x},x.id))}),!o&&s.length?e.jsx(De,{disable:s.length%20!==0,page:n,setPage:i}):null]})}export{Ze as default};
